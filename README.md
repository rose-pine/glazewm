<p align="center">
    ...
    <h2 align="center">Rosé Pine for GlazeWM</h2>
</p>
...
foreground: *text
```
[GlazeWM](https://github.com/glzr-io/glazewm) has many other options like  window border under `focus_borders:`

[Example of a full config](config_example.yaml) 
## Gallery
...
Modify `template.yaml` using Rosé Pine variables, then build variants:

<!-- #rose-pine-build -->

```sh
npx @rose-pine/build@0.8.2 -t template.yaml
```
